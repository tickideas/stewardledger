        ...
        {#each proposals as p}
          <tr>
            ...
            <td class="py-3 font-mono text-xs">
              <a class="hover:underline" href={`/zone/members/${p.primaryMemberId}`}>{p.primaryMemberId.slice(0, 8)}…</a>
            </td>
            <td class="py-3 font-mono text-xs">
              <a class="hover:underline" href={`/zone/members/${p.duplicateMemberId}`}>{p.duplicateMemberId.slice(0, 8)}…</a>
            </td>
