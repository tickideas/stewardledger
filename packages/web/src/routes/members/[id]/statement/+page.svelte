...
<div class="max-w-4xl mx-auto px-6 py-8">
  <a href={`/members/${memberId}`} class="text-sm text-slate-500 hover:underline">← Back to member</a>
        ...
        {#each visibleItems as i (i.id)}
          <tr class="hover:bg-slate-50">
            <td class="py-2 text-slate-700">
              <a href={`/contributions/${i.id}`} class="hover:underline">{i.contributionDate}</a>
            </td>
